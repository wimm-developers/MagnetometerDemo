...
public class MagnetometerDemoActivity extends LauncherActivity implements SensorEventListener {
     ...
     * either near a strong magnet or the device is mis-calibrated. We need
     * to prompt the user to move away or re-calibrate the device.
     */
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            case Sensor.TYPE_MAGNETIC_FIELD:
                ...
                /*
                 * Set the flag for re-calibration when we detect a
                 * mangeticField that is more than RECALIBRATION_THRESHOLD
                 */
                ...
                /*
                 * If we need a re-calibration and the field is low enough
                 * (the user is no longer next to a source of interference), we
                ...
                if (now - mLastInterferenceTime > MS_BETWEEN_INTERFERENCE) {
                    ...
                    /*
                     * We will set the flag to display an interference message
                     * when the magneticField detected is larger than the
